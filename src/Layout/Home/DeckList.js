      ...
      <div className="card-body mt-0 pl-2">
        <div className="text-decoration-underline font-weight-light">
          <div style={{ color: "#606060" }}>
            <h5 className="card-title text-capitalize d-flex pl-3 justify-content-start">
              Deck title
            </h5>
            <h6 className="d-flex card-text font-weight-light mb-0 ml-3">
              Description
            </h6>
            <p className="text-left p-0 ml-3">Number of cards</p>
          </div>
        </div>
        <div className="row justify-content-center pl-4 container-fluid">
          <Link to={`/decks/${id}`} className="btn-xs btn btn-outline-secondary pt-0 pb-1 pr-2 pl-2 ml-4 mr-2">
            <i
          ...
          <Link to={`/decks/${id}/study`} className="btn-xs btn btn-outline-secondary pt-0 pb-1 pr-2 pl-2 ml-2 mr-2">
            <i
